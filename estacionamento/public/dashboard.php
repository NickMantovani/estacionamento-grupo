...
<body>
    ...
    <div class="portfolio-container">
        <div class="portfolio-item">
            ...
            <a href="https://github.com/NickMantovani/estacionamento-grupo" target="_blank">Ver no GitHub</a>
        </div>
        <div class="portfolio-item">
            <h3>Victor Nunes</h3>
            <a href="https://github.com/cappyAI" target="_blank">Ver no GitHub</a>
        </div>
        <div class="portfolio-item">
            <h3>Raphael Dantas</h3>
            <a href="https://github.com/RCastro12200964" target="_blank">Ver no GitHub</a>
        </div>
    </div>
